...
/* 검색 기능 만들기
    1) boardList.jsp 에 가서 검색 버튼에 맵핑(/board/search) 걸기
* */

@Controller
@RequestMapping("/board")
public class Ex12_BoardController {
    ...
    /* 검색 */
    @GetMapping("/search")
    public String search(Ex13_SearchCondition sc, Model m) {
...
System.out.println("pageHandler22 : " + pageHandler);
    ...
    /* 게시글 수정 */
    @PostMapping("/modify")
    public String modify(Ex02_BoardDto boardDto, HttpSession session, Model m) {
